...
test('validation view reports failures honestly and bounds request history', async ({ page }) => {
  ...
  await page.getByRole('button', { name: /Show 20 older requests/ }).click();
