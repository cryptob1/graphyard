...
const generatedIndexes = [
  {
    ...
    head: `<!-- page: Build integrations | 1 | the HTTP API, one topic per page. -->
# Agent protocol and HTTP API`,
  ...
  },
  {
    ...
    sections: ['Start here', 'Operate Graphyard', 'Build integrations', 'Understand or contribute'],
    head: `# Graphyard documentation

Start with the numbered path; the other pages are references to open when a task needs them.`,
    tail: 'This index and docs/protocol.md are generated by `npm run docs:check -- --write`; never edit them by hand.',
  },
];
