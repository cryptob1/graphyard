...
- **Requires:** Node 24, Herdr 0.7.1+, a Graphyard checkout; supervised Muse launch and lifecycle detection need Herdr 0.9.1+ and a provider-authenticated `muse` executable
