...
To withdraw specific accepted runs without changing what the work item requires, revoke that evidence instead of revising requirements; see the [operations runbook](operations.md#accepted-evidence-turns-out-to-be-wrong) and the [protocol](protocol.md#revocation).
