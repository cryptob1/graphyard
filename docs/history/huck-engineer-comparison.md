...
> **Historical research.** Commit references and implementation status below are preserved for context. Use the [current documentation index](/docs/README) for shipped behavior.
