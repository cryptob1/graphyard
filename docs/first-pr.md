...
4. Open a Graphyard-linked pull request and confirm `Graphyard / merge` refuses before acceptance evidence exists, capturing the refusal with the inspection below.
