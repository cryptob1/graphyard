...
| `scripts/check-docs.mjs`, `scripts/docs-budget.mjs`, `scripts/docs-coverage.mjs`, `scripts/docs-duplication.mjs` | Link, anchor and generated-index checks (`npm run docs:check`, `--write`, `--manifest`); word budget, documented-surface coverage and cross-page duplication report |
