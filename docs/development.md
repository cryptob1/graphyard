...
`npm test` hides `GRAPHYARD_*`/`HERDR_*` variables and reserves free Postgres ports. Managed worktrees install under bubblewrap ([preconditions](install.md#preconditions)).
