...
An `e2e:` proof passes only from a pinned candidate and bundle, published by a separate [collector](runner-setup.md).
...
- Operator (`admin`): defines environments and bundles, registers identities, selects, requests, cancels and recovers candidates.
