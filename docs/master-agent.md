...
**Approvers, `master approver` ones too, relaunch** if they end unjudged: 3 sessions per decision, timeouts retried uncounted, then escalated with each `session N:` end reason.
