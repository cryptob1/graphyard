...
export const gateRefusalCatalogue: RefusalShape[] = [
  ...
  { gate: 'merge', id: 'mergeability-computing', match: /^GitHub is computing mergeability against the current base/, example: 'GitHub is computing mergeability against the current base; the next observation reads it again', kinds: ['resync'] },
