import { baseRefreshConflict, defaultMergeBatchSize, ejectedTipRestore, ejectionReason, nextQueueSequence, pendingBaseRefresh, pendingRestore, predecessorWait, predecessorWaitText, queueBatch, queueHistoryLimit, queuePlacement, speculativeConflictReason } from '../merge-queue.js';
