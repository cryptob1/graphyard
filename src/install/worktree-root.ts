...
export const checkoutKinds = ['proof', 'review', 'research', 'approval'] as const;
export type CheckoutKind = typeof checkoutKinds[number];
const managedName = /^graphyard-(proof|review|research|approval)-[a-z0-9][a-z0-9-]{0,39}-[0-9a-f]{7}-[0-9a-f]{8}$/;
