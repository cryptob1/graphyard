...
/** The deployment's declared generated files; a malformed declaration refuses start-up. */
export const configuredGeneratedFiles = (env: NodeJS.ProcessEnv = process.env) => parseGeneratedFiles(env.GRAPHYARD_GENERATED_FILES);
