...
import { CHECK_NAME, evidenceIndependenceRefusals, exhaustedReviewerProfiles, nativeReviewRequired, reviewerProfileFor, reviewProviderOf, standingEscalations, type Work } from './model.js';
