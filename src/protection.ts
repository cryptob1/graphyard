...
export function protectionPlan(current: any, config: { repository: string; baseBranch: string; githubAppId: number }, work: Work[], workflows: WorkflowFile[] = readWorkflows()) {
