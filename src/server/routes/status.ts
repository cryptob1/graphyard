  ...
  },
  {
    ...
    async handle({ actor, req, url, services, operatorVisible }) {
      ...
      for (const work of trimmedView.work) {
        ...
        if (cut) { trimmedView.omitted.dispatchHistory += cut.dispatchHistory; trimmedView.omitted.queueHistory += cut.queueHistory; trimmedView.omitted.actionHistory += cut.actionHistory; }
      }
      return trimmedView;
    },
  },
