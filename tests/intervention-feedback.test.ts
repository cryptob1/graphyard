...
before(async () => {
  ...
  database = new EmbeddedPostgres({ databaseDir: await temporaryDirectory('interventions'), user: 'graphyard', password: 'testing-only', port, persistent: false, onLog: () => {}, onError: () => {}, postgresFlags: ['-h', '127.0.0.1'] });
