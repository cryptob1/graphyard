...
test('D6-6 redaction and retention rules apply to replay inputs and exports', async () => {
  ...
  assert.equal(redactString('eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjM0NTY3ODkwIn0.dozjgNryP4J3jVmNHl0w5N_XgL0n3I9PlFUP0THsR8U ok AKIAIOSFODNN7EXAMPLE'), '[redacted] ok [redacted]');
